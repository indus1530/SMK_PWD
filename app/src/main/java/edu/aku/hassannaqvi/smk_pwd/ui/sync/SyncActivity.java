...
import static edu.aku.hassannaqvi.smk_pwd.core.MainApp.sdDir;
import static edu.aku.hassannaqvi.smk_pwd.core.MainApp.uploadData;
...
import edu.aku.hassannaqvi.smk_pwd.workers.DataDownWorkerALL;
import edu.aku.hassannaqvi.smk_pwd.workers.DataUpWorkerALL;
import edu.aku.hassannaqvi.smk_pwd.workers.PhotoUploadWorker2;
    ...
    public void ProcessStart(View view) {
        ...
        switch (view.getId()) {
            ...
            case R.id.btnUpload:
                ...
                //Staffing
                uploadTables.add(new SyncModel(StaffingContract.StaffingTable.TABLE_NAME));
                try {
                ...
                //Patients
                uploadTables.add(new SyncModel(PatientsContract.PatientsTable.TABLE_NAME));
                try {
                    MainApp.uploadData.add(db.getUnsyncedPatients());
                } catch (JSONException e) {
                    e.printStackTrace();
                    Log.d(TAG, "ProcessStart: JSONException(Patients): " + e.getMessage());
                    Toast.makeText(SyncActivity.this, "JSONException(Patients)" + e.getMessage(), Toast.LENGTH_LONG).show();
                }
            ...
            case R.id.btnSync:
                ...
                if (sync_flag) {
                    ...
                    downloadTables.add(new SyncModel(HFContract.singleHF.TABLE_NAME, select, filter));
